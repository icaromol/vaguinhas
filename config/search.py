...
about_company_bad_words = ["Crossover", "Staffing", "Recruiting", "Headhunter", "RPO"]   # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
did_masters = True                 # True or False, Note: True or False are case-sensitive (MBA conta)
